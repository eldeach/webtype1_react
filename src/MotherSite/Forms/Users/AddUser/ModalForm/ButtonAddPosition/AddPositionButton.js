...
// ======================================================================================== [Import Component] js
import addPositionButtonLang from './addPositionButtonLang.js'
...
function AddPosition(props){
    ...
    const yupSchema = yup.object().shape({
        ...
        .required(addPositionButtonLang.inputField.job_position.valMsg.required[cookies.load('site-lang')]), // 필수 입력 필드
      });
    ...
    const arrAddElement = function (arr, newElement) {
        ...
        if (duplication === 0){
            ...
            alert(addPositionButtonLang.alertMsg.duplicated[cookies.load('site-lang')])
        }
        return tempArr;
    };
                    ...
                    <Paper sx={style.popup.paper} elevation={3}>
                        <div className = "popup-close-button-box"><button className='popup-close-button' onClick={handleModalClose}>X</button></div>
                            ...
                            >
                                ...
                                id="job_position"
                                name="job_position"
                                label={addPositionButtonLang.inputField.job_position.placeholder[cookies.load('site-lang')]}
                                ...
                                id="job_team"
                                name="job_team"
                                label={addPositionButtonLang.inputField.job_team.placeholder[cookies.load('site-lang')]}
                                ...
                                id="job_company"
                                name="job_company"
                                label={addPositionButtonLang.inputField.job_company.placeholder[cookies.load('site-lang')]}
