...
// ======================================================================================== [Import Component] js
// its lang Object
import myPreparedLang from './myPreparedLang'
...
function MyPrepared (props) {
    ...
    useEffect(() =>{
        handlePageTitle(myPreparedLang.formTitle[cookies.load('site-lang')])
